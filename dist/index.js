...
const sessionCookie = "53616c7465645f5f06430fc344f6a7d00854f86cc9a02df5b60ef26c31103223deaf017d7e588ec156cc9a65a8f2a92c9b3156e221264e86cbe6f76f58cedac0";
let list = [];
const list1 = async ()=>{
    const config = {
        method: "GET",
    ...
    return await (0, _axiosDefault.default)(config).then((res)=>res.data).catch((err)=>err);
};
const onListSuccess = (res)=>{
...
list1().then(onListSuccess).catch(onListError);
console.log(list, "data here");
// axios.get('https://adventofcode.com/2022/day/1/input', {
//   headers: {
//     Cookie: `session=${sessionCookie}`
//   }
// }).then(async response => {
// list =  await response.data.trim().split('\n');
//   console.log(list);
// }).catch(error => {
//   console.error(error);
// });
...
var Buffer = require("b620f1cf60036ceb").Buffer;
"use strict";
/**
...
},{"b620f1cf60036ceb":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("a91c8d32339d80d9");
var ieee754 = require("4eee224637f4294f");
...
},{"a91c8d32339d80d9":"eIiSV","4eee224637f4294f":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
